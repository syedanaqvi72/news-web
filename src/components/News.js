...
"publishedAt":"2023-06-05T05:44:00Z","content":"HONG KONG/TAIPEI, June 4 (Reuters) - Hong Kong police said they detained 23 people on Sunday for \"breaching public peace\" and arrested a 53-year-old woman for \"obstructing police officers\" as authori… [+5061 chars]"},{"source":{"id":null,"name":"DW (English)"},"author":"Deutsche Welle","title":"Apple expected to unveil mixed-reality headset - DW (English)","description":"The \"Reality Pro,\" or so it is rumored to be named, could pit Apple against Meta in competition over technology where real and digital worlds meet.",
"url":"https://www.dw.com/en/apple-expected-to-unveil-mixed-reality-headset/a-65823145","urlToImage":"https://static.dw.com/image/64864150_6.jpg","publishedAt":"2023-06-05T04:44:05Z","content":"Apple Inc. is widely expected to announce on Monday a new mixed-reality headgear at its annual Worldwide Developers Conference in California. \r\nIt would mark the tech giant's most significant product… [+1535 chars]"},{"source":{"id":null,"name":"New York Post"},"author":"Associated Press","title":"US, UK navies say they responded to distress call as Iran's Revolutionary Guard 'harassed' ship - New York Post ","description":"The Strait of Hormuz, the narrow mouth of the Persian Gulf, sees 20% of the world’s oil pass through it.",
   ...
   async componentDidMount(){
      console.log("cdm");
           ...
           handleNextClick = async () => {
            console.log();
            if(this.state.page +1>Math.cell(this.state.totalResults/10)){
